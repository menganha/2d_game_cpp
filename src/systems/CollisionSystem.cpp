...
bool
CollisionSystem::IsFullyContained(Position pos_a, Collider coll_a, Position pos_b, Collider coll_b)
{
...
bool
CollisionSystem::HasCollided(Position pos_a, Collider coll_a, Position pos_b, Collider coll_b)
{
