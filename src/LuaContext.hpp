...
public:
  ...
  ~LuaContext();
  void GetLevelData(
    const char* script_path, LevelData& level_data, entt::registry&, entt::dispatcher&, entt::entity);
...
private:
  ...
  static constexpr const char* k_camera_entity = "yage.camera_entity";
  ...
  static FunctionExportedToLua add_enemy, set_music, set_video, add_text, move_player, move_camera, luaopen_yage_level;
